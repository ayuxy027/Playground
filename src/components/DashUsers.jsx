...
export default function DashUsers() {
    ...
    useEffect(() => {
        const fetchUsers = async () => {
            try {
                const res = await fetch(`http://localhost:3000/server/student/getusers`, {
                    credentials: 'include',
                } );
    ...
    const handleShowMore = async () => {
        ...
        try {
            const res = await fetch(`http://localhost:3000/server/student/getusers?startIndex=${startIndex}`, {
                credentials: 'include',
            });
            const data = await res.json();
            if (res.ok) {
    ...
    const handleDeleteUser = async () => {
        try {
            const res = await fetch(`http://localhost:3000/server/student/delete/${userIdToDelete}`, {
                method: 'DELETE',
                credentials: 'include',
            });
            const data = await res.json();
